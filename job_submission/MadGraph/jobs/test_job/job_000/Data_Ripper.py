...
uncomp_dir = "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/test_job/job_000/" + str(Process) #Folder containing all the run data
output_dir = "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/test_job/job_000" + "/Data_Files"
...
creates a list.
    ...
    if os.path.exists(path_to_file) and os.path.exists(path_to_lhe) :
        ...
        file_storage = "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/test_job/job_000" + "/Processed_results/" + str(Process)
                ...
                with open(a_file,'r') as data_file:
                    ...
                    for line in lines:
                        if '# tb' in line:
                            ...
                            # find line containing tb and add value to list
                            temp_line_holder = line.split()
                            print("Found tb=" +  str(temp_line_holder[1]))
            ...
            with open(a_file,'r') as data_file:
                ...
                for line in lines:
                    if '#  Integrated weight (pb)  :' in line:
                        # find line cross-section and add value to our list
                        temp_line_holder = line.split()
