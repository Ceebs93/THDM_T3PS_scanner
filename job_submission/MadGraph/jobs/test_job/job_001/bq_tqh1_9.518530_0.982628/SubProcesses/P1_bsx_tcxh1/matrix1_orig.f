...
C     
C     Process: b s~ > t c~ h1 WEIGHTED<=6 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $    ABS(MDL_MHC*SMALL_WIDTH_TREATMENT)), MDL_WHC)
      ...
      CALL FFS2_4_3(W(1,4),W(1,2),GC_157,GC_141,MDL_MHC, ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFS5_2(W(1,4),W(1,5),GC_142,MDL_MC, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,8),W(1,2),W(1,6),GC_67,AMP(3))
      CALL FFS5_1(W(1,2),W(1,5),GC_169,MDL_MS, FK_ZERO,W(1,8))
