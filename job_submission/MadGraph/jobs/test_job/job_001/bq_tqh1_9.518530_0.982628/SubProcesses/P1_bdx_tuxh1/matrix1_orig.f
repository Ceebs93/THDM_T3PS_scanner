...
C     
C     Process: b d~ > t u~ h1 WEIGHTED<=6 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $    ABS(MDL_MHC*SMALL_WIDTH_TREATMENT)), MDL_WHC)
      ...
      CALL FFS2_4_3(W(1,4),W(1,2),GC_145,GC_165,MDL_MHC, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VSS1_0(W(1,6),W(1,5),W(1,7),GC_69,AMP(1))
      CALL FFV2_3(W(1,4),W(1,2),GC_67,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,7),W(1,6),W(1,5),GC_87,AMP(2))
      CALL FFS5_2(W(1,4),W(1,5),GC_181,MDL_MU, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,8),W(1,2),W(1,6),GC_67,AMP(3))
      CALL FFS5_1(W(1,2),W(1,5),GC_146,MDL_MD, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,4),W(1,8),W(1,6),GC_67,AMP(4))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(2)+AMP(3)+AMP(4)+AMP(5)+AMP(6)+AMP(1)
