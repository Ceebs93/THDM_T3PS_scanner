...
C     
C     Process: b c > t s h1 WEIGHTED<=6 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
        IF(MDL_WH1.NE.0D0) FK_MDL_WH1 = SIGN(MAX(ABS(MDL_WH1),
     $    ABS(MDL_MH1*SMALL_WIDTH_TREATMENT)), MDL_WH1)
        IF(MDL_WHC.NE.0D0) FK_MDL_WHC = SIGN(MAX(ABS(MDL_WHC),
     $    ABS(MDL_MHC*SMALL_WIDTH_TREATMENT)), MDL_WHC)
      ...
      CALL OXXXXX(P(0,4),MDL_MS,NHEL(4),+1*IC(4),W(1,4))
      CALL SXXXXX(P(0,5),+1*IC(5),W(1,5))
      CALL FFV2_3(W(1,1),W(1,3),GC_67,MDL_MW, ZERO,W(1,6))
      CALL FFS2_4_3(W(1,2),W(1,4),GC_157,GC_141,MDL_MHC, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VSS1_0(W(1,6),W(1,5),W(1,7),GC_69,AMP(1))
      CALL FFV2_3(W(1,2),W(1,4),GC_67,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,7),W(1,6),W(1,5),GC_87,AMP(2))
      CALL FFS5_2(W(1,2),W(1,5),GC_142,MDL_MC, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,8),W(1,4),W(1,6),GC_67,AMP(3))
      CALL FFS5_1(W(1,4),W(1,5),GC_169,MDL_MS, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,2),W(1,8),W(1,6),GC_67,AMP(4))
      CALL FFS5_2(W(1,1),W(1,5),GC_127,MDL_MB, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,8),W(1,3),W(1,7),GC_67,AMP(5))
      CALL FFS5_1(W(1,3),W(1,5),GC_173,MDL_MT, FK_MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,1),W(1,8),W(1,7),GC_67,AMP(6))
