...
C     
C     Process: b u > t d h1 WEIGHTED<=6 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $    ABS(MDL_MHC*SMALL_WIDTH_TREATMENT)), MDL_WHC)
      ...
      CALL OXXXXX(P(0,4),MDL_MD,NHEL(4),+1*IC(4),W(1,4))
      CALL SXXXXX(P(0,5),+1*IC(5),W(1,5))
      CALL FFV2_3(W(1,1),W(1,3),GC_67,MDL_MW, ZERO,W(1,6))
      CALL FFS2_4_3(W(1,2),W(1,4),GC_145,GC_165,MDL_MHC, ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFS5_2(W(1,2),W(1,5),GC_181,MDL_MU, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,8),W(1,4),W(1,6),GC_67,AMP(3))
      CALL FFS5_1(W(1,4),W(1,5),GC_146,MDL_MD, FK_ZERO,W(1,8))
