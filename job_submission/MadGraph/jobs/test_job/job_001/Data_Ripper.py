...
uncomp_dir = "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/test_job/job_001/" + str(Process) #Folder containing all the run data
output_dir = "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/test_job/job_001" + "/Data_Files"
...
creates a list.
    ...
    if os.path.exists(path_to_file) and os.path.exists(path_to_lhe) :
        ...
        file_storage = "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/test_job/job_001" + "/Processed_results/" + str(Process)
