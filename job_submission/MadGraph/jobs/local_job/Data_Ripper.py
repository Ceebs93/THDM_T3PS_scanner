...
uncomp_dir = "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/local_job/" + str(Process) #Folder containing all the run data
output_dir = "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/local_job" + "/Data_Files"
...
def get_uncomp_file(Uncomp_dir):
    ...
    if os.path.exists(path_to_file) and os.path.exists(path_to_lhe) :
        ...
        file_storage = "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/local_job" + "/Processed_results/" + str(Process) # name of new folder for storing
