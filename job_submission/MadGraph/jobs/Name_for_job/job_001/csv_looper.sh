...
{	#Double read to skip the header line of data csv
	...
	do
		...
		echo "Line number is: " ${COUNT}
                ...
                python /scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/Name_for_job/job_001/inputcard_editor1.py  $mH $mHc $mA "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/Name_for_job/job_001/basecard_type1.txt" "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/Name_for_job/job_001/runcard.txt" $tb $sinba "bq_tqh1" "/scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/Name_for_job/job_001/" # Here we run, and pass variables to, the inputcard editor. This edits the inputcard for MadGraph

                python /scratch/cb27g11/THDM_T3PS_scanner/packages/MG5_aMC_v3_1_0/bin/mg5_aMC /scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/Name_for_job/job_001/runcard.txt # Here we run MG with the edited inputcard
...
} < <(cut -d "," -f1,2,3,4,6 /scratch/cb27g11/THDM_T3PS_scanner/job_submission/MadGraph/jobs/Name_for_job/split_csv_name_2.csv)
