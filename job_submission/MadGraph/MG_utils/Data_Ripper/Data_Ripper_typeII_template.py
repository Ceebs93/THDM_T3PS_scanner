...
#Note: This version of Data_Ripper_iridis is set to look for tan(beta) values by scanning for\'# tanbeta'
# in the .lhe file. THis is the setup for the type-II model in use, it will NOT work for type-II as this
