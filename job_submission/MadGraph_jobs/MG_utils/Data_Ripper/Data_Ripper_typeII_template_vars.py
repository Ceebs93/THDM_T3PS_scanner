...
print("Data_Ripper will look for variable values in: " + str(proc_out_dir))
print("                                     ")
...
MGVAR1_LABEL_ = Xtrctd_values(File_List, '# tanbeta', 1, Multi=False)
MGVAR2_LABEL_ = Xtrctd_values(File_List, '# sinbma', 1, Multi=False)
MGVAR3_LABEL_ = Xtrctd_values(File_List, "# mh2", 1, Multi=False)
MGVAR4_LABEL_ = Xtrctd_values(File_List, "# mh3", 1, Multi=False)
X_sections = Xsection_values(File_List, '#  Integrated weight (pb)  :', 5,
             Multi=False)

# Changing our variable lists to arrays
MGVAR1_LABEL_ = np.array(MGVAR1_LABEL_)
MGVAR2_LABEL_ = np.array(MGVAR2_LABEL_)
MGVAR3_LABEL_ = np.array(MGVAR3_LABEL_)
MGVAR4_LABEL_ = np.array(MGVAR4_LABEL_)
X_sections = np.array(X_sections)

# Ensuring all values have been correctly read in as floats not strings
MGVAR1_LABEL_ = MGVAR1_LABEL_.astype(float)
MGVAR2_LABEL_ = MGVAR2_LABEL_.astype(float)
MGVAR3_LABEL_ = MGVAR3_LABEL_.astype(float)
MGVAR4_LABEL_ = MGVAR4_LABEL_.astype(float)
X_sections = X_sections.astype(float)

# Create a pandas dataframe to contain data
nw_df = pd.DataFrame({'MGVAR1_LABEL_':MGVAR1_LABEL_, 'MGVAR2_LABEL_':MGVAR2_LABEL_,
                      'MGVAR3_LABEL_':MGVAR3_LABEL_, 'MGVAR4_LABEL_':MGVAR4_LABEL_,
