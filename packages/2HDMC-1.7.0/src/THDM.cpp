...
void THDM::set_kappa_D(double kappa11_d, double kappa22_d, double kappa33_d){

    gsl_matrix_set_zero(kappa_D);
  
  gsl_matrix_set(kappa_D,0,0,kappa11_d);
  gsl_matrix_set(kappa_D,1,1,kappa22_d);
  gsl_matrix_set(kappa_D,2,2,kappa33_d);
...
void THDM::set_kappa_U(double kappa11_u, double kappa22_u, double kappa33_u){

    gsl_matrix_set_zero(kappa_U);
  
  gsl_matrix_set(kappa_U,0,0,kappa11_u);
  gsl_matrix_set(kappa_U,1,1,kappa22_u);
  gsl_matrix_set(kappa_U,2,2,kappa33_u);
}
...
void THDM::set_kappa_L(double kappa11_l, double kappa22_l, double kappa33_l){

    gsl_matrix_set_zero(kappa_L);
  
  gsl_matrix_set(kappa_L,0,0,kappa11_l);
  gsl_matrix_set(kappa_L,1,1,kappa22_l);
  gsl_matrix_set(kappa_L,2,2,kappa33_l);
...
void THDM::set_yukawas_down(double rho11, double rho22, double rho33, double rho12, double rho13, double rho23, double kappa11_d, double kappa22_d, double kappa33_d) {
  yukawas_type=-1;
  set_kappa_D(kappa11_d, kappa22_d, kappa33_d);
 // set_kappa_D();
...
void THDM::set_yukawas_up(double rho11, double rho22, double rho33, double rho12, double rho13,double rho23, double kappa11_u, double kappa22_u, double kappa33_u) {
  yukawas_type=-1;
  set_kappa_U(kappa11_u, kappa22_u, kappa33_u);
 // set_kappa_U();
...
void THDM::set_yukawas_lepton(double rho11, double rho22, double rho33, double rho12, double rho13, double rho23, double kappa11_l, double kappa22_l, double kappa33_l) {
  yukawas_type=-1;
  set_kappa_L(kappa11_l, kappa22_l, kappa33_l);
 // set_kappa_L();
