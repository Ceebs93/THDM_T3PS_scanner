...
class THDM {
  ...
  */
  void set_yukawas_down(double rho11, double rho22, double rho33, double rho12, double rho13, double rho23, double kappa11_d, double kappa22_d, double kappa33_d);
  ...
  */
  void set_yukawas_up(double rho11, double rho22, double rho33, double rho12, double rho13,double rho23, double kappa11_u, double kappa22_u, double kappa33_u);
  ...
  */
  void set_yukawas_lepton(double rho11, double rho22, double rho33, double rho12, double rho13, double rho23, double kappa11_l, double kappa22_l, double kappa33_l);
 ...
 private:
  ...
  void set_kappa_U();
  void set_kappa_L();
  void set_kappa_U(double kappa11_u, double kappa22_u, double kappa33_u);
  void set_kappa_D(double kappa11_d, double kappa22_d, double kappa33_d);
  void set_kappa_L(double kappa11_l, double kappa22_l, double kappa33_l);
