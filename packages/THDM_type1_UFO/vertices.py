...
V_115 = Vertex(name = 'V_115',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_159,(0,1):C.GC_137})
...
V_117 = Vertex(name = 'V_117',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_137,(0,1):C.GC_159})

V_118 = Vertex(name = 'V_118',
               particles = [ P.u__tilde__, P.d, P.h__plus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_145,(0,1):C.GC_165})

V_119 = Vertex(name = 'V_119',
               particles = [ P.c__tilde__, P.s, P.h__plus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_157,(0,1):C.GC_141})
...
V_154 = Vertex(name = 'V_154',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_124,(0,1):C.GC_170})

V_155 = Vertex(name = 'V_155',
               particles = [ P.u__tilde__, P.d, P.G__plus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_130,(0,1):C.GC_178})

V_156 = Vertex(name = 'V_156',
               particles = [ P.c__tilde__, P.s, P.G__plus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_166,(0,1):C.GC_128})
...
V_166 = Vertex(name = 'V_166',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_128,(0,1):C.GC_166})

V_167 = Vertex(name = 'V_167',
               particles = [ P.b__tilde__, P.t, P.G__minus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_170,(0,1):C.GC_124})

V_168 = Vertex(name = 'V_168',
               particles = [ P.d__tilde__, P.u, P.G__minus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS2, L.FFS4 ],
               couplings = {(0,0):C.GC_178,(0,1):C.GC_130})
...
V_275 = Vertex(name = 'V_275',
               ...
               couplings = {(0,0):C.GC_71,(0,1):C.GC_88})
...
V_284 = Vertex(name = 'V_284',
               ...
               couplings = {(0,0):C.GC_70,(0,1):C.GC_89})
