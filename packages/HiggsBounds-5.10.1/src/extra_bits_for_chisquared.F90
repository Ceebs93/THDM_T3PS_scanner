...
! Here we should return the -999 option or set log10sf to maximal value according to the flag.
        ...
        if (sigma .lt. vsmall) then
            ...
            if (filledslice) then
                ...
                !************************************************************
                subroutine get_chisq_with_theory_at_corners(massi, massj, log10sf, chisq_withouttheory, &
                                                            sigma, y, slices_t2, chisq_withtheory)
                    ...
                    write (*, *) 'entered subroutine get_chisq_with_theory_at_corners         ', &
                        trim(createtime(1:2)//':'//createtime(3:4)) &
                        //':'//createtime(5:6)//':'//createtime(7:8)//':'//createtime(9:10)
                    call flush (6)
#endif
...
#endif
                    call f_from_slices_t2(slices_t2, &
                                          m1_at_ref_point_1, m2_at_ref_point_1, &
                                          m1_at_ref_point_2, m2_at_ref_point_2, &
                                          log10sf, &
