...
c..   that fixes the transition to the x->0 result
      ...
      sgg1x0 = sgg1(xt) - xm1**exp*(sgg1(xt)
     &     + dcoefs1(nmtlim1gg,1.d0,0.d0)
     &  - ( 3*c1ggx0( (mt/mh)**2 ) )*ataut2)

c$$$      xeps=1.d-8
c.. old version:
c$$$      sgg1x0 = sgg1(xt)
c$$$     &     - xm1**(nsoft1ggmt+1)*(sgg1(xeps)
c$$$     &     + dcoefs1(1.d0-xeps,0.d0)
c$$$     &     - ( 3*c1ggx0( (mt/mh)**2 ) )*ataut2)
...
c..   that fixes the transition to the x->0 result
      ...
      sqg1x0 = sqg1(xt) - xm1**exp*(sqg1(xt)
...
c..   that fixes the transition to the x->0 result
      ...
      sqqb1x0 = sqqb1(xt) - xm1**exp*(sqqb1(xt))
