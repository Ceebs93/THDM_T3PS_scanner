...
!--------------------------------------------------------------------
 ...
 character(LEN=9),parameter :: HSvers='2.2.3beta'
...
! If false, the reference mass value will be mobs +- dmtheo (depending on predicted mass) 
 ...
 double precision :: assignmentrange_massobs = 1.0D0  
                                              ...
                                              ! measurement.
 double precision :: assignmentrange_LHCrun1 = 3.0D0  
                                              ! This gives the mass range
                                              ! (in standard deviations), in which
                                              ! the Higgs is forced to be assigned to
                                              ! peak observables, which have a mass
...
!---
  ...
  double precision, dimension(11,11) :: CScovSM = 0.0D0
  double precision, dimension(11,11) :: CScov = 0.0D0
  double precision, dimension(11,11) :: CS13covSM = 0.0D0
  double precision, dimension(11,11) :: CS13cov = 0.0D0
...
type HSresults                  
 ...
 double precision :: Chisq_LHCRun1, Chisq_LHCRun1_mu, Chisq_LHCRun1_mh
