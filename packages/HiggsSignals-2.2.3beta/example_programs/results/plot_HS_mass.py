...
files = ["HS_mass_pdf1.dat",\
         "HS_mass_pdf2.dat",\
         "HS_mass_pdf3.dat"]

ls = [ ['blue','dotted'], ['red','solid'], ['green','dashed']] 
...
if dataT[7][0] == 0:
	ax.text(0.02,1.015,r"$\Delta m_H^\text{theo} = "+format(dataT[1][0],'4.2f')+"~\mathrm{GeV}$, $\Lambda = \mathrm{default}$",transform=ax.transAxes)
else:	
