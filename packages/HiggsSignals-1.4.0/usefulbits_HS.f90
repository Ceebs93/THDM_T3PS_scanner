...
! Warning WARNING SILENT mode on
!@swrite(*,*)
!@swrite(*,*)"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
!@swrite(*,*)"~                                                        ~"
!@swrite(*,*)"~      	      HiggsSignals "//adjustl(HSvers)//"	          ~"
!@swrite(*,*)"~                                                        ~"
!@swrite(*,*)"~      Philip Bechtle, Sven Heinemeyer, Oscar Stål,      ~"
!@swrite(*,*)"~              Tim Stefaniak, Georg Weiglein             ~"
!@swrite(*,*)"~                                                        ~"
!@swrite(*,*)"~       arXiv:1305.1933 (Manual)                         ~"
!@swrite(*,*)"~       arXiv:1403.1582 (application + more details)     ~"
!@swrite(*,*)"~                                                        ~"  
!@swrite(*,*)"~ It is based on the HiggsBounds-4 Fortran library.      ~"
!@swrite(*,*)"~ Please consult and cite also the following references  ~"
!@swrite(*,*)"~ for the HiggsBounds program                            ~"
!@swrite(*,*)"~                                                        ~"  
!@swrite(*,*)"~    arXiv:0811.4169, arXiv:1102.1898, arXiv:1311.0055   ~"  
!@swrite(*,*)"~                                                        ~"    
!@swrite(*,*)"~ For updates, additional material, release notes, see:  ~"    
!@swrite(*,*)"~            http://higgsbounds.hepforge.org             ~"
!@swrite(*,*)"~                                                        ~"
!@swrite(*,*)"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
!@swrite(*,*)
!@swrite(*,*)" HiggsSignals collects together results from "
!@swrite(*,*)
!@swrite(*,*)"    * the ATLAS and CMS Collaborations"
!@swrite(*,*)"    * the CDF and D0 Collaborations"
!@swrite(*,*)"    * the program HDECAY (arXiv:hep-ph/9704448)"  
!@swrite(*,*)"    * LHC Higgs Cross Section Working Group"
!@swrite(*,*)"      (arXiv:1101.0593, arXiv:1201.3084, "
!@swrite(*,*)"       arXiv:1307.1347 and ref. therein)"
!@swrite(*,*)
