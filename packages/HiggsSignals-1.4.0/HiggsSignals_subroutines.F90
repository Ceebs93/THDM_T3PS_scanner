...
!@swrite(*,*) "Covariance matrix for relative branching ratio uncertainties read in successfully."
 else
...
! Warning WARNING SILENT mode on
!@swrite(*,*) "Covariance matrix for relative cross section uncertainties read in successfully."
 else
...
! Warning WARNING SILENT mode on
!@swrite(*,'(1X,A,A,1I1,A)') 'Use a '//trim(pdf_desc(pdf))//' probability density function ',&
!@s&  'for the Higgs mass(es) (pdf=',pdf,')'
 endif
